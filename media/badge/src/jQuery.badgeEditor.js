(function($) {
  ...
  var Constructor = function($container, options) {
    ...
    var $btn = $('<button>').addClass('btn').addClass('btn-default').addClass('pull-right').text('Open Image');

    $container.html(
      $('<div>')
        .append($('<div>').addClass('badgeEditor'))
        .append($btn)
        .append($('<div>').addClass('badgeEditor-colors'))
    ...
    $btn.on('click', function() {
      window.open(self.$('.badgeEditor').badgemaker('getImage'));
    });
